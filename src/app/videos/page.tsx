  ...
  return (
    <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-16">
      <div className="mb-14 space-y-3">
        ...
        <p className="text-gray-500 text-sm mt-6">Partidas comentadas, tutoriales y resúmenes de torneos.</p>
      </div>
            ...
            <article key={video.id} className="card-neon overflow-hidden flex flex-col group">
              ...
              <div className="p-5 flex flex-col gap-3 flex-1">
                <span className="font-orbitron text-xs text-neon/50 tracking-wider">
                  {new Date(video.fecha).toLocaleDateString('es-ES', { day: '2-digit', month: 'short', year: 'numeric' })}
                </span>
                <a
                  href={`https://www.youtube.com/watch?v=${video.youtubeId}`}
                  target="_blank"
