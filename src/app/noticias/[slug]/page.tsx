...
export default async function NoticiaPage({ params }: Props) {
  ...
  return (
    <div className="max-w-3xl mx-auto px-4 sm:px-6 py-16">
      ...
      <h1 className="font-orbitron text-3xl font-black text-white leading-snug mb-6">{noticia.titulo}</h1>
      ...
      <div className="mt-16 pt-8 border-t border-neon/10">
        <Link href="/noticias" className="font-orbitron text-xs text-neon/60 hover:text-neon tracking-widest transition-colors">
          ← Todas las noticias
        </Link>
      </div>
    </div>
